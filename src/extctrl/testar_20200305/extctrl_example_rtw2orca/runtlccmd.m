function runtlccmd
% RUNTLCCMD - run tlc command (regenerate C code from .rtw file) for model extctrl_example
% This function will run the tlc command stored in the variable 
% "tlccmd" in tlccmd.mat, whose contents is as follows:
% 
% 	tlc
% 	-r
% 	/home/.disk/merged/sperry-02.control.lth.se/primary/h/home/julian/extctrl/testar_20200305/extctrl_example_rtw2orca/extctrl_example.rtw
% 	/opt/robot/matlab/rtw2orca.tlc
% 	-O/home/.disk/merged/sperry-02.control.lth.se/primary/h/home/julian/extctrl/testar_20200305/extctrl_example_rtw2orca
% 	-I/opt/robot/matlab
% 	-I/home/.disk/merged/sperry-02.control.lth.se/primary/h/home/julian/extctrl/testar_20200305/extctrl_example_rtw2orca/tlc
...
% 	-p10000
   ...
   if ~sysopen
      ...
      rtwprivate('rtwattic', 'setBuildDir', '/home/.disk/merged/sperry-02.control.lth.se/primary/h/home/julian/extctrl/testar_20200305/extctrl_example_rtw2orca');
      rtwprivate('ec_set_replacement_flag', 'extctrl_example');
      load tlccmd.mat;
      savedpwd = pwd;
      cd ..;
